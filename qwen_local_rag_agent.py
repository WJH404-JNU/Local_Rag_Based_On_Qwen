...
st.sidebar.info(f"Run ollama pull {st.session_state.model_version}")
# streamlit run --server.port 8501 rag_tutorials/qwen_local_rag/qwen_local_rag_agent.py
...
if prompt:
    ...
    if st.session_state.rag_enabled:
            ...
            if not st.session_state.force_web_search and st.session_state.vector_store:
                ...
                is_relevant, docs = check_document_relevance(
                    rewritten_query,
...
Please provide a comprehensive answer based on the available information."""
    ...
    st.warning(f"You can directly talk to {st.session_state.model_version} and gemma models locally! Toggle the RAG mode to upload documents!")